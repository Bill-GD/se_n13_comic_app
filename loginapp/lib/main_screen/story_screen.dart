...
class StoryScreen extends StatefulWidget {
  ...
  StoryScreen({required this.imageUrls, required this.title, required this.chapter});
          ...
          children: [
            Column(// hiện tiêu đề chapter
              children: [
                ...
                Text(
                  "${widget.chapter}",
                  style: TextStyle(fontSize: 15, color: mainScreenText,),
                ),
              ], 
            ),
          ],
