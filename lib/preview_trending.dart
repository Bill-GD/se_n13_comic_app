...
class preview_trending extends StatelessWidget{
  ...
  preview_trending({required this.trending_image_pr, required this.trending_title_pr, required this.trending_des_pr, required this.trending_tag_pr});
  @override
  @override
    ...
    child: ListView(
     children: [
        Column(children:[Padding(
          ...
          child: Image.asset(trending_image_pr, alignment: Alignment.topCenter,),),//ảnh tác phẩm
          Padding(
          padding: EdgeInsetsDirectional.fromSTEB(0, 30, 0, 0) ,
